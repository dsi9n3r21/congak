...
const DIV_Y4_NAMES = ["Aiman", "Iman", "Danish", "Sofea", "Adam", "Farah", "Nabil"];
const DIV_Y4_ITEMS = [
  { ms: "biji biskut", en: "biscuits" },
  { ms: "keping stiker", en: "stickers" },
  { ms: "biji belon", en: "balloons" },
] as const;

// Year 4 KSSR "Divide by a 1-Digit Number" (dividend up to 2 digits) —
// the entry-level version of this family. Retrofitted per the Round 19
// content standard: added an equal-sharing word_problem, errorSpotting,
// and a reverseProblem finding the divisor (number of students) given
// the dividend and quotient.
export function generateWholeNumbersDivisionY4(params: GeneratorParams): GeneratedQuestion {
